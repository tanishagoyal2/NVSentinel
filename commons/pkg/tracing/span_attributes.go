...
func addProtoMessageAttributes(attrs *[]attribute.KeyValue, prefix string, msg protoreflect.Message) {
...
func addScalarAttribute(attrs *[]attribute.KeyValue, key string, fd protoreflect.FieldDescriptor, val protoreflect.Value) {
	switch fd.Kind() {
	...
	case protoreflect.Uint32Kind, protoreflect.Uint64Kind,
		...
		*attrs = append(*attrs, attribute.Int64(key, int64(val.Uint())))
...
func addMessageAttribute(attrs *[]attribute.KeyValue, key string, msg protoreflect.Message) {
...
func addMapAttributes(attrs *[]attribute.KeyValue, prefix string, fd protoreflect.FieldDescriptor, m protoreflect.Map) {
	valDesc := fd.MapValue()
...
func addListAttributes(attrs *[]attribute.KeyValue, prefix string, fd protoreflect.FieldDescriptor, list protoreflect.List) {
	if list.Len() == 0 {
		return
	}
...
func detectKeyValueMessage(md protoreflect.MessageDescriptor) (keyFd, valFd protoreflect.FieldDescriptor, ok bool) {
