...
// TraceContextHandler wraps a slog.Handler and adds trace_id and span_id from
// the active OpenTelemetry span in ctx when present. This implements Approach 2
// in docs/designs/028-otel-integration.md: JSON logs to stderr with trace
// correlation for tail-based collectors (e.g. Alloy → OTLP → Panoptes).
