...
func TestWorkqueueDeduplication_WithoutEventID(t *testing.T) {
	...
	// Enqueue first event
	err := mgr.EnqueueEventGeneric(ctx, "node-1", event1, mockDB, mockHealthEventStore, nil)
	...
	err = mgr.EnqueueEventGeneric(ctx, "node-1", event2, mockDB, mockHealthEventStore, nil)
	require.NoError(t, err)
...
func TestWorkqueueDeduplication_MultipleFaultsSameNode(t *testing.T) {
	...
	// Enqueue first fault
	err := mgr.EnqueueEventGeneric(ctx, "node-gpu-1", event1, mockDB, mockHealthEventStore, nil)
	require.NoError(t, err)
	...
	err = mgr.EnqueueEventGeneric(ctx, "node-gpu-1", event2, mockDB, mockHealthEventStore, nil)
	require.NoError(t, err)
...
func TestWorkqueueDeduplication_RealWorldScenario(t *testing.T) {
	...
	err := mgr.EnqueueEventGeneric(ctx, "node-1", quarantineEvent, mockDB, mockHealthEventStore, nil)
	require.NoError(t, err)
	...
	err = mgr.EnqueueEventGeneric(ctx, "node-1", cancelledEvent, mockDB, mockHealthEventStore, nil)
	require.NoError(t, err)
...
func TestWorkqueueDeduplication_DifferentNodes(t *testing.T) {
	...
	err = mgr.EnqueueEventGeneric(ctx, "node-2", event2, mockDB, mockHealthEventStore, nil)
	require.NoError(t, err)
